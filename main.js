...
document.querySelector('.cards').innerHTML = `
        ...
        ${createCard("25/11", "sexta", createGame('wales', '07:00', 'iran') + createGame('quatar', '10:00', 'senegal') + createGame('netherlands', '13:00', 'ecuador') + createGame('england', '16:00', 'USA'))}
        ...
        ${createCard("29/11", "terça", createGame('ecuador', '12:00', 'senegal') + createGame('netherlands', '12:00', 'quatar') + createGame('iran', '16:00', 'USA') + createGame('wales', '16:00', 'england'))}
        ...
        ${createCard("03/12", "sábado", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("04/12", "domingo", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("05/12", "segunda", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("06/12", "terça", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("09/12", "sexta", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("10/12", "sábado", createGame('não-definido', '12:00', 'não-definido') + createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("13/12", "terça", createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("14/12", "quarta", createGame('não-definido', '16:00', 'não-definido'))}
        ${createCard("17/12", "sábado", createGame('não-definido', '12:00', 'não-definido'))}
        ${createCard("18/12", "domingo", createGame('não-definido', '12:00', 'não-definido'))}
